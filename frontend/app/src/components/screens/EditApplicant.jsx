...
function EditApplicant() {
  ...
  const fetchApplicantData = async () => {
    try {
      const response = await fetch(`https://elect-backend-8xzh.onrender.com/api/update_applicant/${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await fetch(`https://elect-backend-8xzh.onrender.com/api/update_applicant/${id}`, {
        method: "POST",
        headers: {
